...
(function () {
  ...
  window.render_identicon_canvases = render_identicon_canvases;
  window.render_identicon = render_identicon;
  window.render_identicon_patch = render_identicon_patch;
